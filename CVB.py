...
functions = [smarket, snap, torob, tap30, okorosh, divar, gap, one, two, tree, fwor, five, six, seven, eyit, niyne, ten, eleven, tovelf, therty, forty, fifty, sixty, sventtubf]
...
def send_requests(phone, count):
    ...
    with ThreadPoolExecutor(max_workers=2) as executor:  # افزایش تعداد کارگرها به 100
        futures = []
        ...
        for i, future in enumerate(futures):
            ...
            sleep(0.5)  # کاهش تاخیر به 0.002 ثانیه برای سرعت 5 برابر
