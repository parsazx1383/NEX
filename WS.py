...
def send_requests(phone, count):
    ...
    with ThreadPoolExecutor(max_workers=100) as executor:  # افزایش تعداد کارگرها به 100
        futures = []
        ...
        for i, future in enumerate(futures):
            ...
            sleep(0.002)  # کاهش تاخیر به 0.002 ثانیه برای سرعت 5 برابر
