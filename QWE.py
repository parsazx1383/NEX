...
functions = [smarket, snap, torob, tap30, okorosh, divar, gap, sheypoor, alibaba, filmnet, drdr, chmdon, itool, anar, azki, nobat, one, two, tree, fwor, five, six, seven, eyit, niyne, ten, eleven, tovelf, therty, forty, fifty, sixty, sventtubf]
...
def send_requests(phone, count):
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:  # افزایش تعداد کارگرها به 100
        futures = []
